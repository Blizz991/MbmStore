...
namespace MbmStore.Infrastructure
{
    public static class Repository
    {
        ...
        static Repository()
        {
            ...
            {
                new Customer(1, "Lasse", "Olsen", new DateTime(1991,02,09), "Naturvej 21", 8361, "Hasselager", new Phone[] { new Phone(1, 12345678, 1, "Mobile"), new Phone(1, 23456789, 2, "Landline") }),
                new Customer(2, "Mikkel", "Viadith", new DateTime(1957,05,17), "Danskgade 23", 8000, "Aarhus", new Phone[] { new Phone(2, 23456781, 3, "Mobile"), new Phone(1, 34567892, 4, "Landline") }),
            ...
            #region invoices
            Invoices.Add(
                new Invoice(1, new DateTime(2021, 02, 01), customers[0])
            );

            Invoices.Add(
                new Invoice(2, new DateTime(2021, 02, 17), customers[1])
            );
